...
var REANNOUNCE_MAX_MS = 15 * 1000 //60 * 60 * 1000
...
Registry.prototype.publish = function (opts) {
  ...
  if (typeof opts.reannounceMax === 'number') {
    REANNOUNCE_MAX_MS = opts.reannounceMax
  }
...
function announce (server, service) {
  ...
  ;(function broadcast () {
    ...
    server.mdns.respond(packet, function () {
      ...
      const nextDelay = delay * REANNOUNCE_FACTOR
      delay = nextDelay > REANNOUNCE_MAX_MS ? REANNOUNCE_MAX_MS : nextDelay
